...
switch ($code) {
    case 'VI':
        ...
        $_SESSION['mission_content'] = '<p>
                 Niềm tin của chúng tôi là không thứ gì có thể tồn tại độc lập trên thế giới này. Chúng ta tồn tại cùng nhau và hỗ trợ nhau phát triển, điều này giúp thế giới trở nên muôn màu muôn vẻ, rực rỡ hơn. Một sản phẩm tuyệt vời không chỉ được thiết kế đẹp, nó còn phải làm cho người mua cảm nhận được giá trị của sản phẩm. Chúng tôi tin rằng, bên cạnh vẻ đẹp, sự thẩm mỹ của sản phẩm, sự thiết kế còn phải phù hợp và hấp dẫn người tiêu dùng. Chúng tôi đã và đang nỗ lực để đón đầu xu hướng thiết kế hiện đại. Trong thực tế, 
                 </p>
                 <p class="center">
                  <strong> We dare to face the negative issues, for we will have the positive solutions to overcome them. <br> - Eric\'s Haywood Chang\'s quote -
                  </strong>
                 </p>
                 <p>
    ...
    case 'CN':
        ...
        $_SESSION['copyright'] = 'Copyright &copy; 2015 Empyrean Design. All rights reserved.';
        $_SESSION['mission_content'] = '<p>我们相信，在这个世界上没有什么存在本身。我们共存彼此和我们是相互依赖上彼此。这造成一个更美好，并有助于颜色的世界。良好的设计是不够;一个伟大的产品是一个就能卖自己。我们认为，销售的设计是最相关，并呼吁消费者，除了美学方面的设计。我们是领先的设计趋势，而事实上，趋势制定者，因为我们敢于在我们的思维过程的不同。我们在设计理念至关重要，但能够提供长期的解决方案。我们拥有懂得整合的组件和问题，将提供全面，实用，经济的解决方案，在人力资源，运营成本和利润的操作方面。我们主要关注的是提供一个梦幻般的设计，而且在客户资源的长期保存也是如此。</p>
                 <p class="center">
        ...
        $_SESSION['story_content'] = '<p>恩碧亚设计公司(Empyrean Design)成立于1992年由郑杰明先生。从艺术中新加坡拉萨尔学院已经毕业;主修室内设计和较小的产品设计和美术，他也是一位自学成才的建筑设计师是拥有多年相关领域的经验和专业知识。他热衷于设计，艺术和音乐。</p>
                 <p>
