    ...
    <body class="gallery">
        ...
        <div class="main-container">
            ...
            <div class="main clearfix wrapper">
                ...
                <div class="album-cateogry-list">
                    <div class="album-category">
                      <h2 class="page-title">Singapore</h2>
                        <div class="item-list">
                            <div class="item album">
                                <a class="link-style-none" href="gallery_details.html">
                                    <div class="thumbs">
                                    ...
                                    <div class="item-info nowrap">
                                        <strong class="item-name">Album 1</strong>
