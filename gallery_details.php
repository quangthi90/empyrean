...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Empyrean Design - Gallery</title>
    ...
    <body class="gallery">
        ...
        <div class="main-container">
            ...
            <div class="main clearfix wrapper">
                ...
                <h2 class="page-title">Albums/Project Name</h2>
                <div class="item-list image-list-popup">
                    <div class="item">
                        <div class="thumbs">
                            <a class="popup-image" href="img/albums/a1/i01.jpg">
                                <img src="img/albums/a1/i01.jpg" alt="">
                            </a> 
                        </div>
                        <div class="item-info nowrap">
                            <strong class="item-name">Image name</strong>
                            <div class="overlay"></div>
                        </div>                               
                    </div>
                    <div class="item">
                        <div class="thumbs">
                            <a class="popup-image" href="img/albums/a1/i02.jpg">
                                <img src="img/albums/a1/i02.jpg" alt="">
                            </a> 
                        </div>
                        <div class="item-info nowrap">
                            <strong class="item-name">Image name</strong>
                    ...
                    <div class="item">
                        <div class="thumbs">
                            <a class="popup-image" href="img/albums/a1/i03.jpg">
                                <img src="img/albums/a1/i03.jpg" alt="">
                            </a> 
                        </div>
                        <div class="item-info nowrap">
                            <strong class="item-name">Image name</strong>
                ...
                <div class="controlpanel-details">
                    ...
                    <div class="language-control">
                        ...
                        <div class="language-list">
                            <ul class="none-style">
                                <li>
                                    <a href="#" title="English">English
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="Chinese">Chinese (中文)
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="Bahasa">Bahasa (Indonesian)
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="Japanese">Japanese (日本語)
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="Korean">Korean (한국어)
                                    </a>
                                </li>                            
                                <li>
                                    <a href="#" title="Myanmar">Burmese (Myanmar)
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="Vietnam">Vietnamese (Tiếng Việt)
                                    </a>
                                </li>                                
                            </ul>
        ...
        <script src="js/vendor/carousel/owl.carousel.min.js"></script>
